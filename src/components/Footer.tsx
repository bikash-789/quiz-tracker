    ...
    <footer className="bg-background border-t py-8 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-3">AI Quiz Tracker</h3>
            <p className="text-muted-foreground text-sm">
              Improve your AI knowledge through interactive quizzes and track your progress over time.
            </p>
          </div>
          <div>
        ...
        <div className="border-t mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            &copy; {currentYear} AI Quiz Tracker. All rights reserved.
          </p>
